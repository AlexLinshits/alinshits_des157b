...
md`<div style="color: grey; font: 13px/25.5px var(--sans-serif); text-transform: uppercase;"><h1 style="display: none;">Market Cap for Fashion Companies Bar Chart Race</div>

# Market Cap for Fashion Companies Bar Chart Race

This chart animates the value (in $B) of the top global fashion brands from 2003 to 2024. Color indicates country of origin.`
)}

function _data(FileAttachment){return(
FileAttachment("Sheet 1-category-brands.csv").csv({typed: true})
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["Sheet 1-category-brands.csv", {url: new URL("./files/3b1e92cdb603839950485c13d4d86e1e8832f18f874905b6605aae62e529c9f0514edebb00cd8b5b2b44fd6036624060ecccc9dc58c4bef5d7b3e36d84cf103b.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
